  ...
  return (
    <PageWrapper>
      ...
      <Container>
        ...
        <br />
        <Paragraph>
          Welcome to the Industrial Wet Canteen of Naval Dockyard,
          Visakhapatnam. To ensure smooth, hygienic, and efficient operations,
          all personnel and users must adhere to the following rules and
          guidelines:
        </Paragraph>
        ...
        <Paragraph>
          • ⚠️{" "}
          <em>
            Canteen Management reserves the right to revise or update these
